...
const PropertyPopup: React.FC<{ property: PropertyData; isOpen: boolean; onClose: () => void }> = ({ property, isOpen, onClose }) => {
      ...
      <div className="bg-white rounded-3xl p-6 relative z-10 shadow-lg transform transition-all duration-300 w-[50%] h-[90%] overflow-y-auto">
        ...
        <div className="relative z-20">
          ...
          <div className="relative h-64 w-full mb-4 rounded-lg overflow-hidden">
            <Image src={propertyImg} alt={property.name} layout="fill" className="object-fill"/>
          </div>
          ...
          {/* Property Price */}
          <p className="text-xl text-green-600 mb-4">${property.price.toLocaleString()}</p>
          ...
          <div className="mb-4">
            ...
            <p><strong>Square Feet:</strong> {property.squareFeet.toLocaleString()} sqft</p>
